...
func (l *DistributedLog) setupRaft(dataDir string) error {
	...
	ls, err := newLogStore(logDir, logConfig)
	if err != nil {
		return err
	}
	...
	l.raft, err = raft.NewRaft(config, f, ls, stableStore, snapshotStore, transport)
	if err != nil {
		return err
	}
	hasState, err := raft.HasExistingState(ls, stableStore, snapshotStore)
	if err != nil {
		return err
	}
	if err != nil {
	...
	if l.config.Raft.Bootstrap && !hasState {
		...
		err = l.raft.BootstrapCluster(c).Error()
	}
	return err
}
